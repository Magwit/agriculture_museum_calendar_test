diment /// <reference types="Cypress" />
...
describe("Event calendar", () => {
            ...
            it("Fills in date range and location", () => {
                    ...
                    cy.get('#DatumDO').type("        // THEN The user can see NZM events that take place in Prague during August 2020
                        cy.get('.btn > .fa').click() cy.url().should('include', 'coHledate')
                    })
